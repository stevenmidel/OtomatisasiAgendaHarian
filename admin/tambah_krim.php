...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $stmt = $conn->prepare("INSERT INTO produk_krim (nama_produk, deskripsi, harga_produk, gambar_produk) VALUES (?, ?, ?, ?)");
  ...
  <div class="flex-1 flex flex-col">
    ...
    <main class="flex flex-col items-center p-6">
      ...
      <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-lg">
        <form action="tambah_krim.php" method="POST" enctype="multipart/form-data">
          <!-- Nama Produk -->
          <div class="mb-4">
