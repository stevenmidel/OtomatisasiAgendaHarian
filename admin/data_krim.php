...
<body class="h-screen flex bg-gray-100">
  ...
  <div class="flex-1 flex flex-col">
    ...
    <main class="flex-1 p-6">
      <h1 class="text-2xl font-bold text-gray-700">Data Keseluruhan Produk Krim-Malam</h1>
      ...
      <div class="overflow-x-auto mt-6">
        <table class="table-fixed min-w-full border-collapse bg-white shadow-md rounded-lg">
          ...
          <tbody class="text-gray-700">
            ...
            $sql = "SELECT id, nama_produk, deskripsi, harga_produk, gambar_produk FROM produk_krim";
            ...
            if ($result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                echo "<td class='px-6 py-3 border-b text-center'><a href='edit_krim.php?id={$row['id']}' class='text-blue-500 hover:text-blue-700'><i class='fas fa-edit'></i></a></td>";
                echo "<td class='px-6 py-3 border-b text-center'><a href='hapus_krim.php?id={$row['id']}' class='text-red-500 hover:text-red-700' onclick=\"return confirm('Yakin ingin menghapus produk ini?');\"><i class='fas fa-trash-alt'></i></a></td>";
                echo "</tr>";
              }
            } else {
