...
$query = "SELECT gambar_produk, nama_produk, deskripsi, harga_produk FROM produk_pencuci";
  ...
  <nav class="bg-white shadow">
    <div class="container mx-auto flex justify-between items-center py-4 px-4">
      ...
      <ul class="flex space-x-6">
        <li>
          <a class="nav-item " href="index1.php"><strong>Home</strong></a>
        </li>
        <li>
          <a class="nav-item text-blue-500" href="index2.php"><strong>Pencuci Muka</strong></a>
        </li>
        <li>
...
<section class="bg-gray-100 py-16">
  <div class="flex flex-col md:flex-row items-center pl-4 md:pl-8 pr-4">
    <div class="md:w-1/2 text-center md:text-left">
      ...
      <p class="text-gray-600 mb-6">
        Nikmati Wajah Cerah dan Berkilau dengan pencuci muka produk kami
      </p>
    </div>
  </div>
</section>
